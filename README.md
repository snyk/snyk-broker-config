...
snyk-broker-config/1.8.2 linux-x64 node-v20.14.0
...
```
USAGE
  $ snyk-broker-config connections create INSTALLID DEPLOYMENTID [APIURL]
...
_See code: [src/commands/connections/create.ts](https://github.com/snyk/snyk-broker-config/blob/v1.8.2/src/commands/connections/create.ts)_
...
```
USAGE
  $ snyk-broker-config connections delete INSTALLID DEPLOYMENTID CONNECTIONID
...
_See code: [src/commands/connections/delete.ts](https://github.com/snyk/snyk-broker-config/blob/v1.8.2/src/commands/connections/delete.ts)_
...
```
USAGE
  $ snyk-broker-config connections list INSTALLID DEPLOYMENTID [APIURL]
...
_See code: [src/commands/connections/list.ts](https://github.com/snyk/snyk-broker-config/blob/v1.8.2/src/commands/connections/list.ts)_
...
```
USAGE
  $ snyk-broker-config connections update INSTALLID DEPLOYMENTID CONNECTIONID
    [APIURL] [APIVERSION] -t <value> -n <value> [--broker_client_url <value>] [--checkmarx <value>]
...
_See code: [src/commands/connections/update.ts](https://github.com/snyk/snyk-broker-config/blob/v1.8.2/src/commands/connections/update.ts)_
...
```
USAGE
  $ snyk-broker-config credentials create INSTALLID DEPLOYMENTID [APIURL]
...
_See code: [src/commands/credentials/create.ts](https://github.com/snyk/snyk-broker-config/blob/v1.8.2/src/commands/credentials/create.ts)_
...
```
USAGE
  $ snyk-broker-config credentials delete INSTALLID DEPLOYMENTID [APIURL]
...
_See code: [src/commands/credentials/delete.ts](https://github.com/snyk/snyk-broker-config/blob/v1.8.2/src/commands/credentials/delete.ts)_
...
```
USAGE
  $ snyk-broker-config credentials list INSTALLID DEPLOYMENTID [APIURL]
    [APIVERSION] [--json] [--log-level debug|warn|error|info|trace]
...
_See code: [src/commands/credentials/list.ts](https://github.com/snyk/snyk-broker-config/blob/v1.8.2/src/commands/credentials/list.ts)_
...
```
USAGE
  $ snyk-broker-config credentials update INSTALLID DEPLOYMENTID [APIURL]
...
_See code: [src/commands/credentials/update.ts](https://github.com/snyk/snyk-broker-config/blob/v1.8.2/src/commands/credentials/update.ts)_
...
```
USAGE
  $ snyk-broker-config deployments create INSTALLID APPINSTALLEDINORGID [APIURL]
    [APIVERSION] -d <value> [--json] [--log-level debug|warn|error|info|trace]
...
_See code: [src/commands/deployments/create.ts](https://github.com/snyk/snyk-broker-config/blob/v1.8.2/src/commands/deployments/create.ts)_
...
```
USAGE
  $ snyk-broker-config deployments delete INSTALLID DEPLOYMENTID [--json]
...
_See code: [src/commands/deployments/delete.ts](https://github.com/snyk/snyk-broker-config/blob/v1.8.2/src/commands/deployments/delete.ts)_
...
```
USAGE
  $ snyk-broker-config deployments list INSTALLID [APIURL] [APIVERSION] [--json]
    [--log-level debug|warn|error|info|trace]
...
_See code: [src/commands/deployments/list.ts](https://github.com/snyk/snyk-broker-config/blob/v1.8.2/src/commands/deployments/list.ts)_
...
```
USAGE
  $ snyk-broker-config deployments update INSTALLID DEPLOYMENTID -d <value> [--json]
    [--log-level debug|warn|error|info|trace]
...
_See code: [src/commands/deployments/update.ts](https://github.com/snyk/snyk-broker-config/blob/v1.8.2/src/commands/deployments/update.ts)_
...
```
USAGE
  $ snyk-broker-config integrations create INSTALLID CONNECTIONID ORGID INTEGRATIONID
    TYPE [APIURL] [APIVERSION] [--json] [--log-level debug|warn|error|info|trace]
...
_See code: [src/commands/integrations/create.ts](https://github.com/snyk/snyk-broker-config/blob/v1.8.2/src/commands/integrations/create.ts)_
...
```
USAGE
  $ snyk-broker-config integrations delete INSTALLID CONNECTIONID ORGID INTEGRATIONID
    [APIURL] [APIVERSION] [--json] [--log-level debug|warn|error|info|trace]
...
_See code: [src/commands/integrations/delete.ts](https://github.com/snyk/snyk-broker-config/blob/v1.8.2/src/commands/integrations/delete.ts)_
...
```
USAGE
  $ snyk-broker-config integrations list INSTALLID CONNECTIONID [APIURL]
    [APIVERSION] [--json] [--log-level debug|warn|error|info|trace]
...
_See code: [src/commands/integrations/list.ts](https://github.com/snyk/snyk-broker-config/blob/v1.8.2/src/commands/integrations/list.ts)_
...
_See code: [src/commands/introduction/index.ts](https://github.com/snyk/snyk-broker-config/blob/v1.8.2/src/commands/introduction/index.ts)_
...
_See code: [src/commands/workflows/connections/create.ts](https://github.com/snyk/snyk-broker-config/blob/v1.8.2/src/commands/workflows/connections/create.ts)_
...
_See code: [src/commands/workflows/connections/delete.ts](https://github.com/snyk/snyk-broker-config/blob/v1.8.2/src/commands/workflows/connections/delete.ts)_
...
_See code: [src/commands/workflows/connections/disconnect.ts](https://github.com/snyk/snyk-broker-config/blob/v1.8.2/src/commands/workflows/connections/disconnect.ts)_
...
_See code: [src/commands/workflows/connections/get.ts](https://github.com/snyk/snyk-broker-config/blob/v1.8.2/src/commands/workflows/connections/get.ts)_
...
_See code: [src/commands/workflows/connections/integrate.ts](https://github.com/snyk/snyk-broker-config/blob/v1.8.2/src/commands/workflows/connections/integrate.ts)_
...
```
USAGE
  $ snyk-broker-config workflows credentials delete INSTALLID [APIURL] [APIVERSION] [--json]
    [--log-level debug|warn|error|info|trace]
...
_See code: [src/commands/workflows/credentials/delete.ts](https://github.com/snyk/snyk-broker-config/blob/v1.8.2/src/commands/workflows/credentials/delete.ts)_
...
_See code: [src/commands/workflows/deployments/create.ts](https://github.com/snyk/snyk-broker-config/blob/v1.8.2/src/commands/workflows/deployments/create.ts)_
...
_See code: [src/commands/workflows/deployments/get.ts](https://github.com/snyk/snyk-broker-config/blob/v1.8.2/src/commands/workflows/deployments/get.ts)_
<!-- commandsstop -->
