...
export const flagConnectionMapping: TypeMapping = {
  apprisk: {
    ...
    checkmarx_password: {
      description: 'Checkmarx Password Credentials Reference UUID (leave empty if not using Checkmarx)',
      sensitive: true,
      skippable: true,
      prohibitedValues: [],
    },
  ...
  jira: {
    ...
    jira_password: {
      description: 'Jira Password Credentials Reference UUID (leave empty if using PAT)',
      sensitive: true,
      skippable: true,
      prohibitedValues: [],
    },
  ...
  'bitbucket-server': {
    ...
    bitbucket_password: {
      description: 'Bitbucket Password Credentials Reference UUID (leave empty if using PAT)',
      sensitive: true,
      skippable: true,
      prohibitedValues: [],
    },
    bitbucket_pat: {
      description: 'Bitbucket Pat Credentials Reference UUID (leave empty if using user/pass)',
      sensitive: true,
      skippable: true,
      prohibitedValues: [],
    },
  ...
  acr: {
    ...
    cr_agent_url: {
      description: 'Container Registry Agent URL (Must be the URL of your container registry agent)',
      dataType: 'url',
      prohibitedValues: [],
    },
    cr_base: {
      description: 'Container Registry Base URL (The hostname of your CR)',
      dataType: 'hostname',
      prohibitedValues: [],
    },
    cr_username: {description: 'Container Registry Username', prohibitedValues: []},
    cr_password: {
      description: 'Container Registry Password Credentials Reference UUID',
      sensitive: true,
      prohibitedValues: [],
    },
  },
  ...
  'digitalocean-cr': {
    ...
    cr_token: {
      description: 'Container Registry Token Credentials Reference UUID',
      sensitive: true,
      prohibitedValues: [],
    },
  },
